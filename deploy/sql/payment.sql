...
CREATE TABLE `payment`  (
  ...
  `pay_total` bigint(0) NOT NULL DEFAULT 0 COMMENT '支付总金额(分)',
  ...
  `pay_time` datetime(0) NOT NULL DEFAULT '1970-01-01 08:00:00' COMMENT '支付成功时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_sn`(`sn`) USING BTREE,
  UNIQUE INDEX `idx_order_sn`(`order_sn`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '第三方支付流水记录' ROW_FORMAT = Dynamic;
