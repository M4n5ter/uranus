...
func (c *stockClient) ReleaseStockByTicketID(ctx context.Context, in *ReleaseStockByTicketIDReq, opts ...grpc.CallOption) (*ReleaseStockResp, error) {
	out := new(ReleaseStockResp)
	err := c.cc.Invoke(ctx, "/pb.stock/ReleaseStockByTicketID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stockClient) ReleaseStockByTicketIDRollBack(ctx context.Context, in *ReleaseStockByTicketIDReq, opts ...grpc.CallOption) (*ReleaseStockResp, error) {
	out := new(ReleaseStockResp)
	err := c.cc.Invoke(ctx, "/pb.stock/ReleaseStockByTicketIDRollBack", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stockClient) ReleaseStockBySpaceID(ctx context.Context, in *ReleaseStockBySpaceIDReq, opts ...grpc.CallOption) (*ReleaseStockResp, error) {
	out := new(ReleaseStockResp)
	err := c.cc.Invoke(ctx, "/pb.stock/ReleaseStockBySpaceID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stockClient) ReleaseStockBySpaceIDRollBack(ctx context.Context, in *ReleaseStockBySpaceIDReq, opts ...grpc.CallOption) (*ReleaseStockResp, error) {
	out := new(ReleaseStockResp)
	err := c.cc.Invoke(ctx, "/pb.stock/ReleaseStockBySpaceIDRollBack", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StockServer interface {
	...
	//通过 ticketID 释放锁定的库存
	ReleaseStockByTicketID(context.Context, *ReleaseStockByTicketIDReq) (*ReleaseStockResp, error)
	//通过 ticketID 释放锁定的库存 rollback
	ReleaseStockByTicketIDRollBack(context.Context, *ReleaseStockByTicketIDReq) (*ReleaseStockResp, error)
	//通过 spaceID 释放锁定的库存
	ReleaseStockBySpaceID(context.Context, *ReleaseStockBySpaceIDReq) (*ReleaseStockResp, error)
	//通过 spaceID 释放锁定的库存 rollback
	ReleaseStockBySpaceIDRollBack(context.Context, *ReleaseStockBySpaceIDReq) (*ReleaseStockResp, error)
...
func (UnimplementedStockServer) ReleaseStockByTicketID(context.Context, *ReleaseStockByTicketIDReq) (*ReleaseStockResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReleaseStockByTicketID not implemented")
}
func (UnimplementedStockServer) ReleaseStockByTicketIDRollBack(context.Context, *ReleaseStockByTicketIDReq) (*ReleaseStockResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReleaseStockByTicketIDRollBack not implemented")
}
func (UnimplementedStockServer) ReleaseStockBySpaceID(context.Context, *ReleaseStockBySpaceIDReq) (*ReleaseStockResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReleaseStockBySpaceID not implemented")
}
func (UnimplementedStockServer) ReleaseStockBySpaceIDRollBack(context.Context, *ReleaseStockBySpaceIDReq) (*ReleaseStockResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReleaseStockBySpaceIDRollBack not implemented")
}
...
func _Stock_ReleaseStockByTicketID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseStockByTicketIDReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServer).ReleaseStockByTicketID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.stock/ReleaseStockByTicketID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServer).ReleaseStockByTicketID(ctx, req.(*ReleaseStockByTicketIDReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Stock_ReleaseStockByTicketIDRollBack_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseStockByTicketIDReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServer).ReleaseStockByTicketIDRollBack(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.stock/ReleaseStockByTicketIDRollBack",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServer).ReleaseStockByTicketIDRollBack(ctx, req.(*ReleaseStockByTicketIDReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Stock_ReleaseStockBySpaceID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseStockBySpaceIDReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServer).ReleaseStockBySpaceID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.stock/ReleaseStockBySpaceID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServer).ReleaseStockBySpaceID(ctx, req.(*ReleaseStockBySpaceIDReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Stock_ReleaseStockBySpaceIDRollBack_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseStockBySpaceIDReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServer).ReleaseStockBySpaceIDRollBack(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.stock/ReleaseStockBySpaceIDRollBack",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServer).ReleaseStockBySpaceIDRollBack(ctx, req.(*ReleaseStockBySpaceIDReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Stock_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReleaseStockByTicketID",
			Handler:    _Stock_ReleaseStockByTicketID_Handler,
		},
		{
			MethodName: "ReleaseStockByTicketIDRollBack",
			Handler:    _Stock_ReleaseStockByTicketIDRollBack_Handler,
		},
		{
			MethodName: "ReleaseStockBySpaceID",
			Handler:    _Stock_ReleaseStockBySpaceID_Handler,
		},
		{
			MethodName: "ReleaseStockBySpaceIDRollBack",
			Handler:    _Stock_ReleaseStockBySpaceIDRollBack_Handler,
		},
	},
