...
type AddStockByTicketIDRollBackLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewAddStockByTicketIDRollBackLogic(ctx context.Context, svcCtx *svc.ServiceContext) *AddStockByTicketIDRollBackLogic {
	return &AddStockByTicketIDRollBackLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *AddStockByTicketIDRollBackLogic) AddStockByTicketIDRollBack(in *pb.AddStockByTicketIDReq) (*pb.AddStockResp, error) {
