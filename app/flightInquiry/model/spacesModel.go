...
func (m *defaultSpacesModel) Insert(session sqlx.Session, data *Spaces) (sql.Result, error) {
	...
	return m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.Exec(query, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.DelState, data.Version, data.FlightInfoId, data.IsFirstClass, data.Price, data.Surplus)
		}
		return conn.Exec(query, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.DelState, data.Version, data.FlightInfoId, data.IsFirstClass, data.Price, data.Surplus)
	}, spacesIdKey)
...
func (m *defaultSpacesModel) Update(session sqlx.Session, data *Spaces) (sql.Result, error) {
	...
	return m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.Exec(query, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.DelState, data.Version, data.FlightInfoId, data.IsFirstClass, data.Price, data.Surplus, data.Id)
		}
		return conn.Exec(query, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.DelState, data.Version, data.FlightInfoId, data.IsFirstClass, data.Price, data.Surplus, data.Id)
	}, spacesIdKey)
}
...
func (m *defaultSpacesModel) UpdateWithVersion(session sqlx.Session, data *Spaces) error {
	...
	sqlResult, err = m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.Exec(query, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.DelState, data.Version, data.FlightInfoId, data.IsFirstClass, data.Price, data.Surplus, data.Id, oldVersion)
		}
		return conn.Exec(query, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.DelState, data.Version, data.FlightInfoId, data.IsFirstClass, data.Price, data.Surplus, data.Id, oldVersion)
	}, spacesIdKey)
	if err != nil {
		return err
	}
