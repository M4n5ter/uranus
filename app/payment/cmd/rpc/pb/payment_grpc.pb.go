...
func (c *paymentClient) UpdateTradeStateRollBack(ctx context.Context, in *UpdateTradeStateReq, opts ...grpc.CallOption) (*UpdateTradeStateResp, error) {
	out := new(UpdateTradeStateResp)
	err := c.cc.Invoke(ctx, "/pb.payment/UpdateTradeStateRollBack", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServer interface {
	...
	//UpdateTradeStateRollBack 回滚更新交易状态
	UpdateTradeStateRollBack(context.Context, *UpdateTradeStateReq) (*UpdateTradeStateResp, error)
	//GetPaymentSuccessRefundByOrderSn 根据订单sn查询流水记录
...
func (UnimplementedPaymentServer) UpdateTradeStateRollBack(context.Context, *UpdateTradeStateReq) (*UpdateTradeStateResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTradeStateRollBack not implemented")
}
...
func _Payment_UpdateTradeStateRollBack_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTradeStateReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServer).UpdateTradeStateRollBack(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.payment/UpdateTradeStateRollBack",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).UpdateTradeStateRollBack(ctx, req.(*UpdateTradeStateReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Payment_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateTradeStateRollBack",
			Handler:    _Payment_UpdateTradeStateRollBack_Handler,
		},
		{
