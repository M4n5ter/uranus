...
func (c *usercenterClient) GetAvatarSrc(ctx context.Context, in *GetAvatarSrcReq, opts ...grpc.CallOption) (*GetAvatarSrcResp, error) {
	out := new(GetAvatarSrcResp)
	err := c.cc.Invoke(ctx, "/pb.usercenter/GetAvatarSrc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usercenterClient) GetUserWallet(ctx context.Context, in *GetUserWalletReq, opts ...grpc.CallOption) (*GetUserWalletResp, error) {
	out := new(GetUserWalletResp)
	err := c.cc.Invoke(ctx, "/pb.usercenter/GetUserWallet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsercenterServer interface {
	...
	GetAvatarSrc(context.Context, *GetAvatarSrcReq) (*GetAvatarSrcResp, error)
...
func (UnimplementedUsercenterServer) GetAvatarSrc(context.Context, *GetAvatarSrcReq) (*GetAvatarSrcResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAvatarSrc not implemented")
}
func (UnimplementedUsercenterServer) GetUserWallet(context.Context, *GetUserWalletReq) (*GetUserWalletResp, error) {
...
func _Usercenter_GetAvatarSrc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAvatarSrcReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsercenterServer).GetAvatarSrc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.usercenter/GetAvatarSrc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).GetAvatarSrc(ctx, req.(*GetAvatarSrcReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Usercenter_GetUserWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserWalletReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsercenterServer).GetUserWallet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.usercenter/GetUserWallet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).GetUserWallet(ctx, req.(*GetUserWalletReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Usercenter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAvatarSrc",
			Handler:    _Usercenter_GetAvatarSrc_Handler,
		},
		{
			MethodName: "GetUserWallet",
			Handler:    _Usercenter_GetUserWallet_Handler,
		},
	},
